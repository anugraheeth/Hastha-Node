...
<button class="bu b" onclick="location.href='filterAdvbuild.php';" style="vertical-align:middle"><span>Building Based Filter</span></button> 
 
      
<button class="bu" onclick="location.href='../index.php';" style="vertical-align:middle"><span>Back to Dashboard</span></button>
